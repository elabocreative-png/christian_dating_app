...
Repository integration tests use `fake_cloud_firestore` (see `test/block_repository_test.dart`, `test/chat_repository_test.dart`, `test/matches_repository_test.dart`).
